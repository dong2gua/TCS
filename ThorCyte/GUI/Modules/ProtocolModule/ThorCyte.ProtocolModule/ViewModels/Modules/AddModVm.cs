...
{
    public class AddModVm : ModuleBase
    {        
        ...
        public override void OnExecute()
        {
            try
            {
                ...
                var processedImg = _img1.Add(_img2, Macro.ImageMaxBits);
                ...
                {
                    throw new CyteException("AddModVm", "Invaild execution image is null");
                }
