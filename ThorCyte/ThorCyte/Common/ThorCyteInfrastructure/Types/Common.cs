...
{
    public enum CaptureMode { Mode1D, Mode2D, Mode3D, Mode2DTimingStream, Mode2DTiming, Mode2DStream, Mode3DTimingStream, Mode3DTiming, Mode3DStream };
    public enum RegionShape { None, Point, Line, Rectangle, Ellipse, Polygon }
